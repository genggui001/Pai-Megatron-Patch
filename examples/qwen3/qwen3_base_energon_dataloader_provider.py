...
def train_valid_test_dataloaders_provider(train_val_test_num_samples):
    ...
    train_dataloader = get_savable_loader(train_ds, worker_config=worker_config, watchdog_timeout_seconds=120)
    valid_dataloader = get_loader(val_ds, worker_config=worker_config, watchdog_timeout_seconds=120)
