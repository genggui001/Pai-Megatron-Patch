...
class MyTaskEncoder(
    ...
    def __init__(
        ...
        self.no_think_start_flag = [248045, 74455, 198, 248068, 271, 248069, 271]
        self.think_start_flag = [248045, 74455, 198, 248068, 198]
        self.end_flag = [248046]
        # self.start_offset = 2
